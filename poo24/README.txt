...
descripcion
al ejecutarlo se muestra una ventana con un lineedit y dso botones, en el lineedit se puede ingresar una url y descaraga 
todos los archivos que se usen como recurso para una pagina web con sus limitaciones, hay archivos que no se pueden 
para cada arcivo pide una carpeta donde se descargara , con el otro bton se puede seleccionar una imagen para cambiar el fondo