...
descripcion
es un login que funciona igua al de la actividad 14, valida con la muisam base , db2.db, al validar
abre una ventana con un boton para volver a el login, lo nuevo es la clase master que se ocupa de 
