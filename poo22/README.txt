...
descripcion
al ejecutarlos e muestra una ventana con botones para sonar , macar y agregar instrumento, solo se puede agregar Guitarra, Teclado o Bateria
hay un desplegable que muestra los instrumentos, en lista de 1 a 5 para los queya estan agregados por defecto y Guitarra, Bateria y Teclado para los nuevos
