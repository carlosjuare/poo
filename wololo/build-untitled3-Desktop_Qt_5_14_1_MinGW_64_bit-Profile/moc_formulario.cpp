...
QT_MOC_LITERAL(1, 11, 17), // "contraseaCambiada"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 14) // "nuevaContrasea"

    },
    "Formulario\0contraseaCambiada\0\0"
    "nuevaContrasea"
};
...
void Formulario::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->contraseaCambiada((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (Formulario::*)(const QString & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Formulario::contraseaCambiada)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Formulario::contraseaCambiada(const QString & _t1)
{
